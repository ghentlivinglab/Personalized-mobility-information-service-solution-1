...
angular.module("mobiliteit").controller("EditTravelModalCtrl",
    ["$scope", "$uibModalInstance", "uiGmapGoogleMapApi", "alertify", "$q", "TransportationType", "AuthService", "PointOfInterest", "User", "$uibModal", "travel",
        function ($scope, $uibModalInstance, uiGmapGoogleMapApi, alertify, $q, TransportationType, AuthService, PointOfInterest, User, $uibModal,  travel) {
            ...
            //add the route to the array of routes and reset it
            ...
            $scope.finish = function () {
                $scope.saveroute();
                $uibModalInstance.close([$scope.travel, $scope.routes, false]);
            };

            $scope.addReverse = function () {
                $scope.saveroute();
                $uibModalInstance.close([$scope.travel, $scope.routes, true]);
             };
            ...
            $scope.clearMap = function () {
                $scope.showMap = false;
                $scope.route.transportation_type = undefined;
            };
