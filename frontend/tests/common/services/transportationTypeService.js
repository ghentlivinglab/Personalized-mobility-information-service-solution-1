...
var POSSIBLE_TRANSPORTATION_TYPES = ["bus", "car", "bike", "train", "streetcar"];

function generateFakeTransportationType() {
    return faker.random.arrayElement(POSSIBLE_TRANSPORTATION_TYPES);
}
